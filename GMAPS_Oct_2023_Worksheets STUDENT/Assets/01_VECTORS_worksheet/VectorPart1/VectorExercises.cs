...
public class VectorExercises : MonoBehaviour
{
    ...
    public void Question3a()
    {
        ...
        HVector2D c = a + b;
        Vector2 vec1 = new Vector2(a.x, a.y);
        Vector2 vec2 = new Vector2(b.x, a.y);
        Vector2 vec3 = new Vector2(c.x, c.y);
    ...
    {
        HVector2D a = new HVector2D(3, 5);
        HVector2D b = new HVector2D(3*2, 5*2);
